...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <SiteNav
        active={activeSection as "roast-me" | "mt-roastmore" | "archetypes"}
              ...
              <div id="roast-me" className="max-w-6xl mx-auto scroll-mt-20">
                ...
                <div className="text-center mb-8 lg:mb-12">
                  <span className="font-mono text-[11px] uppercase tracking-[0.2em] text-indigo-300/70">
                    PM Roast · AI Career Coach
                  </span>
                  <h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.04] text-balance">
                    Get roasted.{" "}
                    <span className="bg-gradient-to-r from-amber-300 via-orange-400 to-rose-500 bg-clip-text text-transparent">
                      Get your PM card.
                    </span>
                  </h1>
                  <p className="mx-auto mt-5 max-w-lg text-base sm:text-lg leading-relaxed text-white/55">
                    Brutally honest AI career coaching, informed by 200+{" "}
                    <a
                      href="https://www.youtube.com/@LennysPodcast"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-white/80 font-medium underline decoration-white/20 underline-offset-4 hover:text-[#818cf8] hover:decoration-[#818cf8]/50 transition-colors"
                    >
                      Lenny&apos;s Podcast
                    </a>
                    {" "}episodes.
                ...
                <div className="flex flex-col lg:flex-row gap-8 items-center justify-center">
                  ...
                  {/* Right: Input Form - refined glass surface */}
                  <div className="relative w-[350px]">
                    {/* Restrained single-hue glow */}
                    <div className="absolute -inset-2 bg-indigo-500/15 rounded-3xl blur-2xl pointer-events-none" />
                    {/* Hairline top-lit gradient border */}
                    <div className="absolute -inset-px bg-gradient-to-b from-white/[0.12] to-white/[0.02] rounded-[21px] pointer-events-none" />
                    <Card className="relative p-6 bg-[#0e0e12]/85 backdrop-blur-xl border-0 shadow-2xl shadow-black/50 rounded-[20px]">
                <AnimatePresence mode="wait">
                  {inputMode === "magic" ? (
                    <motion.div
                      key="magic"

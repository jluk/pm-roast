    ...
    const imageResponse = new ImageResponse(
      (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%", height: "100%", backgroundColor: "#0a0a0a", color: "white" }}>
          <span style={{ fontSize: 36, fontWeight: 700, color: "#f59e0b", marginBottom: 8 }}>{safeName}</span>
          <span style={{ fontSize: 80, fontWeight: 700 }}>{safeScore}/100</span>
          <span style={{ fontSize: 16, color: "#6366f1", marginTop: 32 }}>pmroast.com</span>
        </div>
      ),
